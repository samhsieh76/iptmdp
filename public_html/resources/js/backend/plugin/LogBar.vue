                ...
                series: [
                    {
                        ...
                        itemStyle: {
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
                                { offset: 1, color: "rgba(106, 209, 174, 0.8)" },
                                { offset: 0, color: "rgba(19, 147, 199, 0.8)" },
                            ]),
                        },
                        data: [],
                        emphasis: {
        ...
        const reload = () => {
            updateData()
                .then((res) => {
                    ...
                    // @todo x軸顯示方式看要不要調整
                    let title = "";
                    title = globalProperties.$t('search_log_options')[props.searchValue.date_interval]
