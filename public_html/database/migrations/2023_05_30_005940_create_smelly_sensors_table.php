...
class CreateSmellySensorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('smelly_sensors', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('max_value', 5, 2)->default(20.0)->comment('最大值');
            $table->decimal('critical_value', 5, 2)->default(15.0)->comment('臨界值，此處指恢復正常的值');
    ...
    {
        Schema::dropIfExists('smelly_sensors');
    }
}
