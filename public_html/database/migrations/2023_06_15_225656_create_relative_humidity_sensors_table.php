...
class CreateRelativeHumiditySensorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('relative_humidity_sensors', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('relative_humidity_sensors');
    }
}
