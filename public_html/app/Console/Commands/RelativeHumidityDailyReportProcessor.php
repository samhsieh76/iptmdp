...
class RelativeHumidityDailyReportProcessor extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'DailyReportProcess:RelativeHumidity  {--date=today}';
     ...
     * @var string
     */
    protected $description = 'Process data for relative humidity daily report.';
        ...
        foreach ($dates as $date) {
            ...
            try {
                $logs = RelativeHumidityLog
                    ...
                    ->groupBy('relative_humidity_sensor_id')
                    ->get();

                RelativeHumidityDailyReport::upsert(
                    $logs->toArray(),
                    ['relative_humidity_sensor_id', 'date'],
                    [
                        'relative_humidity_sensor_id',
                        'date',
                        'average_value',
