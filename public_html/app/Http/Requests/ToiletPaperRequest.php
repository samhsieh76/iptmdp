...
class ToiletPaperRequest extends FormRequest {
    /**
    ...
    public function createRules(): array {
        return [
            ...
            // 'sensor_id' => ['required', 'alpha_dash'. 'string', 'max:45', Rule::unique('toilet_paper_sensors')],
            'min_value' => ['required', 'min:0', 'max:100'],
            'max_value' => ['required', 'min:0', 'max:100', 'gt:min_value'],
    ...
    public function updateRules(): array {
        return [
            'name' => 'required|string|max:45',
            // 'sensor_id' => ['required', 'alpha_dash'. 'string', 'max:45', Rule::unique('toilet_paper_sensors')->ignore($this->route('sensor'))],
            'min_value' => ['required', 'min:0', 'max:100'],
            'max_value' => ['required', 'min:0', 'max:100', 'gt:min_value'],
            'is_notification' => ['required', 'boolean']
        ];
    ...
    public function messages() {
        return [
            'max_value.gt' => trans('validation.gt.numeric', ['attribute' => trans('messages.max_value'), 'value' => trans('messages.min_value')])
        ];
    }
