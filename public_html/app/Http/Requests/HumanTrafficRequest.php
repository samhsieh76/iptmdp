...
class HumanTrafficRequest extends FormRequest {
    /**
    ...
    public function createRules(): array {
        return [
            ...
            'critical_value' => ['required', 'min:0', 'max:10000'],
            'min_value' => ['required', 'min:0', 'max:10000'],
    ...
    public function attributes() {
        return [
            ...
            'min_value' => trans('messages.deviation_value'),
